...
<div id="container">
    ...
    if(isset($_POST['submit'])) {
        ...
        if ($antuser==$antwoord){
            ...
            echo"<div onclick=\"location.href= 'min.php?groep=$groep'\" id=\"\" class=\"\">";
        ...
        echo"<form action=\"min.php?groep=$groep\" method=\"post\">";
        echo"<label>".$getal1." - ".$getal2."<input type=\"text\" name=\"awu\"></label>";
        echo"<a href=\"http://localhost/desplinter/php/min.php\">";
